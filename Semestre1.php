...
<header id="header">
 ...
 <div class="a">
    <h1 class="h1">Ptéridophytes</h1><br>
...
<script>
    ...
    // Utilisation de localStorage pour récupérer l'état côté client
    var registrationKeyValidated = localStorage.getItem('registrationKeyValidated');
    if (registrationKeyValidated === 'true') {
...
function checkRegistrationKey() {
    ...
    if (registrationKey === "2021") {
        // Utilisation de localStorage pour stocker l'état côté client
        localStorage.setItem('registrationKeyValidated', 'true');
        window.location.href = "Cours2.php";
    } else {
