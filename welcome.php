...
<!-- Navigation Bar -->
	<header id="header">
		<nav>
			...
			<div  class="srch"><input  type="text" id="searchInput" class="search" placeholder="Search cours..."> 
				<a href="#facultie"><button  onclick="search()"></button></a>
...
<div class="service-swipe">
		...
		<a href="subjects/jee.html"><div class="s-card"><img src="images/icon/brainbooster.png"><p>Events / News</p></div></a>
		<a href="#"><div class="s-card"><img src="images/icon/online-tutorials.png"><p>Faculté de Technologie (182)</p></div></a>
		<a href="subjects/jee.html#sample_papers"><div class="s-card"><img src="images/icon/papers.jpg"><p>Institut d'Architecture et Urbanisme (9)</p></div></a>
